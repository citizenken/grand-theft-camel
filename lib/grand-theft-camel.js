...
Crafty.c("WhiteCharacter", {
    init: function() {
        this.requires("SpriteAnimation, WiredHitBox, Persist, SpriteAnimation, spr_white_player").reel("PlayerUp", 400, 0, 2, 3).reel("PlayerDown", 400, 0, 0, 3).reel("PlayerRight", 400, 0, 3, 3).reel("PlayerLeft", 400, 0, 1, 3).reel("PlayerSwordRight", 200, 0, 5, 5).reel("PlayerSwordLeft", 200, 0, 4, 5).reel("PlayerSwordDown", 200, 0, 6, 5).bind("AnimationEnd", function(data) {
...
Crafty.c("HUD", {
    ...
    createHpBar: function() {
        var heart = Crafty.e("HUDElement, Color").color("red").attr({
            x: 10,
            y: 10,
            w: 12,
            h: 15
    ...
    createThirstBar: function() {
        var waterdrop = Crafty.e("HUDElement, Color").color("blue").attr({
            x: 53,
            y: 10,
            w: 12,
            h: 15
