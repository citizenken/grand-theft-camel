...
Crafty.scene("Loading", function() {
    ...
    Crafty.load([ "assets/actors/camel.png", "assets/actors/player_character.png", "assets/actors/lead_camel_white.png", "assets/actors/human_sword.png" ], function() {
...
Crafty.c("Enemy", {
    init: function() {
        this.requires("Actor, Fourway, Collision, SpriteAnimation, spr_blue_enemy, TargetMovement").attr({
            steps: 0,
            direction: null,
            maxSteps: 0,
            aggroDistance: 200,
        ...
        this.bind("EnterFrame", function() {
            ...
            this.trigger("Moved");
        }).reel("EnemyUp", 400, 0, 4, 3).reel("EnemyDown", 400, 0, 6, 3).reel("EnemyRight", 400, 0, 5, 3).reel("EnemyLeft", 400, 0, 7, 3).bind("NewDirection", function(movement) {
            if (movement.x != this._oldMovementx || movement.y != this._oldMovementy) {
                if (movement.y == -1) {
...
Crafty.c("Player_Standard_White_Sprite", {
    init: function() {
        this.requires("SpriteAnimation, spr_white_player").reel("PlayerUp", 400, 0, 2, 3).reel("PlayerDown", 400, 0, 0, 3).reel("PlayerRight", 400, 0, 3, 3).reel("PlayerLeft", 400, 0, 1, 3);
    }
});

Crafty.c("Player_Sword", {
    init: function() {
        this.requires("SpriteAnimation, spr_white_player_sword").reel("PlayerSwordRight", 200, 0, 7, 4).reel("PlayerSwordLeft", 200, 0, 8, 4);
    }
});
...
Crafty.c("Player", {
    _direction: null,
    init: function() {
        this.requires("Actor, Fourway, Collision, SpriteAnimation, Solid, Player_Standard_White_Sprite").fourway(1).reel("PlayerUp", 400, 0, 2, 3).reel("PlayerDown", 400, 0, 0, 3).reel("PlayerRight", 400, 0, 3, 3).reel("PlayerLeft", 400, 0, 1, 3).reel("PlayerSwordRight", 200, 0, 9, 5).reel("PlayerSwordLeft", 200, 0, 8, 5).bind("KeyDown", function(e) {
            switch (e.key) {
              case Crafty.keys["M"]:
                Game.playerKeys["M"] = true;
                break;
