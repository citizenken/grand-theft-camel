...
Crafty.c("WhiteCharacter", {
    init: function() {
        this.requires("SpriteAnimation, WiredHitBox, Persis, SpriteAnimation, spr_white_player").reel("PlayerUp", 400, 0, 2, 3).reel("PlayerDown", 400, 0, 0, 3).reel("PlayerRight", 400, 0, 3, 3).reel("PlayerLeft", 400, 0, 1, 3).reel("PlayerSwordRight", 200, 0, 5, 5).reel("PlayerSwordLeft", 200, 0, 4, 5).reel("PlayerSwordDown", 200, 0, 6, 5).bind("AnimationEnd", function(data) {
...
Crafty.c("Player", {
    ...
    _moveSpeed: 1,
    init: function() {
        this.requires("Actor, Fourway, Collision, FPS, Persist, Solid").fourway(this._moveSpeed).bind("EnterFrame", function(data) {
            this.checkDead();
        }).bind("KeyDown", function(e) {
            switch (e.key) {
              case Crafty.keys.M:
