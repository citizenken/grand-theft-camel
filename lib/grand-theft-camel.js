...
Crafty.c("Camel", {
    ...
    init: function() {
        ...
        this._speed = Math.round(Crafty.math.randomNumber(.5, 2.5));
        this._oldMovementx;
        this._oldMovementy;
...
Crafty.c("Enemy", {
    ...
    _maxSteps: 0,
    init: function() {
        this.requires("Actor, Fourway, Collision, SpriteAnimation, WiredHitBox, spr_blue_enemy, TargetMovement").attr({
            steps: 0,
            direction: null,
            aggroDistance: 200,
            targetLocation: {
...
Crafty.c("WhiteCharacter", {
    init: function() {
        this.requires("Actor, Fourway, Collision, FPS, SpriteAnimation, WiredHitBox, Solid, spr_white_player").fourway(1).reel("PlayerUp", 400, 0, 2, 3).reel("PlayerDown", 400, 0, 0, 3).reel("PlayerRight", 400, 0, 3, 3).reel("PlayerLeft", 400, 0, 1, 3).reel("PlayerSwordRight", 200, 0, 9, 5).reel("PlayerSwordLeft", 200, 0, 8, 5).bind("EnterFrame", function(data) {
            this.checkDead();
        }).bind("KeyDown", function(e) {
            switch (e.key) {
              case Crafty.keys["M"]:
