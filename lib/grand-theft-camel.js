...
Crafty.c("SandDune", {
    init: function() {
        this.requires("Scenery, Color").color("white");
    }
});
...
var openDesertSection00 = [ "oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo", "#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o", "############################################################", "############################################################", "############w###############################################", "############@###############################################", "############################################################", "############################################################", "##################################wwwwwwwwwwwwwwww##########", "############################################################", "############################################################", "############################################################", "############################################################", "############################################################", "############################################################", "############################################################", "############################################################", "#oooooooooooooooooooooooooooo##oooooooooooooooooooooooooooo#", "############################################################", "############################################################", "############################################################", "####################################oooooooo################", "#############t#######t#############ooooooooo################", "#t#################################ooooooooo################", "######t##################t#########oooooo###################", "#################t#################oooooo#oooo##############", "###################################oooooooooooo#############", "######t#############################ooooooooooo#############", "####################################ooooooooooo#############", "###############t#####################oooooooooo#############", "######################################oooooooo##############", "###t##############t#####################oooo################", "############################################################", "############################################################", "############################################################", "############################################################" ];
              ...
              default:
                if (y % (Game.map_grid.height / 2) === 0 || x % (Game.map_grid.width / 2) === 0 || x === Game.map_grid.width - 1 || y === Game.map_grid.height - 1) {
                    ...
                    if (x % (Game.map_grid.width / 2) === 0 || x === Game.map_grid.width - 1) {
                        ...
                        newVoid._onEdge = {
                            x: xLinesAt[xLinesAt.indexOf(x)],
                            y: null,
                            start: x,
                            end: x + Game.map_grid.width / 2,
                            zone: xLinesAt.indexOf(x)
                        };
                    }
                    if (y % (Game.map_grid.height / 2) === 0 || y === Game.map_grid.height - 1) {
                        ...
                        newVoid._onEdge = {
                            x: null,
                            y: yLinesAt[yLinesAt.indexOf(y)],
                            start: y,
                            end: y + Game.map_grid.height / 2,
                            zone: yLinesAt.indexOf(y)
                        };
                    }
                } else {
    ...
    if (y) {
        for (y = y; y < end; y++) {
            for (x = 0; x < mapArray[y].length; x++) {
                if (!occupied[y][x] && Math.random() < .01 && x !== playerx && y !== playery) {
                    i++;
